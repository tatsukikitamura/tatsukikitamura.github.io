  ...
  nav.innerHTML = `
    <div class="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
      <a href="/" class="font-bold text-xl tracking-tight text-white hover:text-indigo-300 transition-colors">
        <span class="gradient-text">Tatsuki</span><span class="text-zinc-500">.</span><span class="gradient-text">dev</span>
      </a>
      ...
      <!-- Mobile Menu Button -->
      <button id="mobile-menu-btn" class="md:hidden p-2 text-zinc-700 hover:text-white" aria-label="メニューを開く">
